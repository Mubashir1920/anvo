...
export function OrdinaryAnnuity() {
  ...
  const [pvPrincipal, setPvPrincipal] = useState<number>(0)
  const [pvAnnuityType, setPvAnnuityType] = useState<"ordinary" | "due">("ordinary")
  ...
  const [fvAnnuityType, setFvAnnuityType] = useState<"ordinary" | "due">("ordinary")
  ...
  return (
    <div>
      <h1 className="text-center my-2 text-xl font-semibold"> Annuity Calculator </h1>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <RadioGroup
                  value={pvAnnuityType}
                  onValueChange={(value) => {
                    setPvAnnuityType(value as "ordinary" | "due")
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <RadioGroup
                  value={fvAnnuityType}
                  onValueChange={(value) => {
                    setFvAnnuityType(value as "ordinary" | "due")
                    // Reset values but keep the new annuity type
                    setFvPayment(1000)
                    setFvRate(5)
                    setFvPeriods(10)
