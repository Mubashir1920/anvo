  ...
  return (
    <div className="container flex-grow    mx-auto flex justify-center items-start  pt-20">
      <div className="py-8 text-center ">
        ...
        <p className="mb-8 text-lg  text-gray-500 lg:text-xl sm:px-16 xl:px-48 motion-opacity-in-0 motion-translate-y-in-[96%] motion-blur-in-md motion-delay-300 ">
        ...
        <div className="grid grid-cols-1 grid-flow-row lg:grid-cols-3 gap-5 lg:gap-2">
          ...
          <Link href='/future-value'>
            <div className="border relative cursor-pointer shadow-sm group dark:hover:bg-green-950/70  duration-200   hover:border-green-300 hover:bg-green-50 dark:hover:border-green-800   rounded-sm p-5 text-left card-animate " >
          ...
          <Link href='/present-value'>
            <div className="border relative group cursor-pointer shadow-sm duration-200  card-animate  hover:border-purple-300 hover:bg-purple-50 dark:hover:bg-purple-950/50 dark:hover:border-purple-950   rounded-sm p-5 text-left" >
              <h3 className="font-semibold " >
          ...
          <Link href='/irregular-calculator'>
            <div className="border relative group cursor-pointer card-animate shadow-sm duration-200   hover:border-red-300 hover:bg-red-50 dark:hover:bg-red-950/50 dark:hover:border-red-950   rounded-sm p-5 text-left" >
              <h3 className="font-semibold " >
          ...
          <Link href='/annuity-calculator'>
            <div className="border relative group cursor-pointer card-animate shadow-sm duration-200   hover:border-blue-300 hover:bg-blue-50 dark:hover:bg-blue-950/50 dark:hover:border-blue-950   rounded-sm p-5 text-left" >
              <h3 className="font-semibold " >
                Annuity Calculator
              </h3>
